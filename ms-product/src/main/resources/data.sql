...
INSERT INTO products (id, name, description, price, stock, category, image_url, active, created_at, updated_at) VALUES (3, 'Java Programming', 'Comprehensive Java guide', 39.90, 45, 'BOOKS', 'http://example.com/img3.jpg', TRUE, '2025-01-03 09:00:00', NULL);
...
INSERT INTO products (id, name, description, price, stock, category, image_url, active, created_at, updated_at) VALUES (6, 'Bluetooth Speaker', 'Portable speaker with bass', 49.99, 60, 'ELECTRONICS', 'http://example.com/img6.jpg', TRUE, '2025-01-06 10:30:00', NULL);
...
INSERT INTO products (id, name, description, price, stock, category, image_url, active, created_at, updated_at) VALUES (8, 'Data Structures', 'Algorithms and data structures book', 45.00, 30, 'BOOKS', 'http://example.com/img8.jpg', TRUE, '2025-01-08 11:30:00', NULL);
