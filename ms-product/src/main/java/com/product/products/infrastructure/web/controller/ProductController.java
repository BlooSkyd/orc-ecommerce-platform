...
import com.product.products.application.service.ProductService;
...
public class ProductController {
     ...
     */
    @Operation(summary = "Créer un nouvel produit", 
               description = "Crée un nouvel produit avec les données fournies")
    @ApiResponses(value = {
    ...
    public ResponseEntity<ProductResponseDTO> createProduct(
        ...
        log.info("Reçu : {}", productRequestDTO);
        
        ProductResponseDTO createdProduct = productService.createProduct(productRequestDTO);
        
        // Best practice REST : retourner le URI de la ressource créée dans le header Location
     ...
     * 
     * @param id Le identifiant du produit
    ...
    @ApiResponses(value = {
        ...
        @ApiResponse(responseCode = "404", 
                    ...
                    content = @Content),
        @ApiResponse(responseCode = "409", 
                    description = "Conflit avec un produit existant",
                    content = @Content)
    })
    @PutMapping(value = "/{id}", 
    ...
    @Operation(summary = "Récupérer les produits en stock",
               description = "Retourne la liste de tous les produits en stock")
    @ApiResponses(value = {
    ...
    public ResponseEntity<List<ProductResponseDTO>> getAvailableProducts() {
        log.info("GET /api/v1/products/active - Récupération des produits en stock");
     ...
     * 
     * @param id Le identifiant du produit
     * @return Le produit désactivé
     */
    @Operation(summary = "Modifier le stock d'un produit",
    ...
    public ResponseEntity<ProductResponseDTO> changeProductStock(
            @Parameter(description = "ID du produit", required = true)
            @PathVariable Long id,
            @Valid @RequestBody StockUpdateRequestDTO stockDTO) {
        
        log.info("PATCH /api/v1/products/{}/stock - Modification du stock du produit à {}", id, stockDTO);
        
        ProductResponseDTO deactivatedProduct = productService.updateStock(id, stockDTO.getStockModification());
