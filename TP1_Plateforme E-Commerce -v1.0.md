...
**Durée estimée** : 2 semaines, date limite d'envoi le lundi 15/12 à minuit
**Travail** : En binôme ou trinôme  
**Email-Receiver**:  rkarra.okad@gmail.com
**Soutenance**: La prochaine seance, le mardi 16/15. Ordre de passage en LIFO. 
---
...
|---------|----------|-------------|---------|------------|
| GET | `/api/v1/products` | Liste tous les produits | OK      | OK         |
| GET | `/api/v1/products/{id}` | Détail d'un produit | OK      | OK         |
| POST | `/api/v1/products` | Créer un produit | OK      | OK         |
| PUT | `/api/v1/products/{id}` | Modifier un produit | OK      | OK         |
| DELETE | `/api/v1/products/{id}` | Supprimer un produit | OK      | OK         |
| GET | `/api/v1/products/search?name={name}` | Recherche par nom | OK      | OK         |
| GET | `/api/v1/products/category/{category}` | Filtrer par catégorie | OK      | OK         |
| GET | `/api/v1/products/available` | Produits en stock | OK      | OK         |
| PATCH | `/api/v1/products/{id}/stock` | Mettre à jour le stock | OK      | OK         |

#### Fonctionnalités spécifiques

- **Validation** : Prix > 0, stock >= 0, catégorie valide
- **Business Rules** :
  - Un produit ne peut pas être supprimé s'il est dans une commande --> TODO
